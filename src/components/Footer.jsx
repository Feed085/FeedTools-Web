                    ...
                    <div className="footer-main">
                        ...
                        <div className="footer-links-group">
                            ...
                            <div className="footer-social-row">
                                ...
                                <a href="https://www.instagram.com/feed.studio._?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" rel="noreferrer" className="social-icon-btn instagram" aria-label="Instagram">
                                    <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
