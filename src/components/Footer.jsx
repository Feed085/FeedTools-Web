            ...
            <div className="footer-container">
                <div className="footer-main">
                    ...
                    <div className="footer-links-group">
                        <h4 className="footer-group-title">Keşfet</h4>
                        <ul className="footer-links-list">
                            <li><a href="#games">Oyun Listesi</a></li>
                            <li><a href="#bypass">Bypass Listesi</a></li>
                            <li><a href="#denuvo">Denuvo Listesi</a></li>
                        </ul>
                    </div>
                    ...
                    <div className="footer-links-group">
                        ...
                        <div className="footer-social-row">
                            ...
                            <a href="https://instagram.com/feedtools" target="_blank" rel="noreferrer" className="social-icon-btn instagram" aria-label="Instagram">
                                <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
                ...
                <div className="footer-bottom">
                    <p className="footer-copyright">© 2025 FeedTools Tüm hakları saklıdır.</p>
