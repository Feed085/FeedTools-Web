                    ...
                    <div className="footer-main">
                        ...
                        <div className="footer-brand-info">
                            <div className="footer-logo-row">
                                <img src={logo} alt="Gamonk Logo" className="footer-logo" />
                                <span className="footer-brand-name">Gamonk</span>
                            </div>
                        ...
                        <div className="footer-links-group">
                            ...
                            <div className="footer-social-row">
                                <a href="https://discord.gg/gamonk" target="_blank" rel="noreferrer" className="social-icon-btn discord" aria-label="Discord">
                                ...
                                <a href="https://youtube.com/@gamonk" target="_blank" rel="noreferrer" className="social-icon-btn youtube" aria-label="Youtube">
                                    <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
